...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        dataset=dict(
            type=dataset_type,
            data_root=data_root,
            ann_file= data_root +  'scannet_infos_train_pts.pkl', #'scannet_infos_train_pts_10scenes.pkl', #'scannet_infos_train_pts.pkl',
...
val_dataloader = dict(
    ...
    dataset=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file= data_root + 'scannet_infos_val_pts.pkl', #'scannet_infos_train_pts_10scenes.pkl', #'scannet_infos_val_pts.pkl', # 

...
class PackNeRFDetInputs(BaseTransform):
    ...
    NERF_INPUT_KEYS = [
        'img', 'denorm_images', 'depth', 'lightpos', 'nerf_sizes', 'raydirs', 'c2w', 'intrinsic', 'points', 'pose_matrix', 'axis_align_matrix', 'avg_distance', 'points_first_axis'
    ]
    ...
    def pack_single_results(self, results: dict) -> dict:
        ...
        if 'points_first_axis' in results:
            if isinstance(results['points_first_axis'], BasePoints):
                results['points_first_axis'] = results['points_first_axis'].tensor
        ...
        for key in [
                ...
                'pts_semantic_mask', 'centers_2d', 'depths', 'gt_labels_3d', 'pose_matrix', 'axis_align_matrix', 'avg_distance', 'points_first_axis'
        ]:

...
class VGGTDetDataPreprocessor(DetDataPreprocessor):
    ...
    def simple_process(self, data: dict, training: bool = False) -> dict:
        ...
        if 'points_first_axis' in inputs:
            batch_inputs['points_first_axis'] = inputs['points_first_axis']
        ...
        keys_to_check = ['lightpos', 'nerf_sizes', 'denorm_images', 'raydirs', 'c2w', 'intrinsic', 'pose_matrix', 'axis_align_matrix', 'avg_distance','points_first_axis']
